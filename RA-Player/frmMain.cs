...
namespace RAPlayer
{
    public partial class frmMain : Form
    {
        ...
        private void fnReadINI()
        {
            ...
            {
                MessageBox.Show(null, "No Configuration file found!\nPlease Configure RA-Player.", "RA-Player :: First Run", MessageBoxButtons.OK, MessageBoxIcon.Information);
                fnRunConfig();
            }          
        }
        ...
        private void RAPlayerUI_Load(object sender, EventArgs e)
        {
            fnStartRAPlayer();
        }
        ...
        private void aboutRAPlayerToolStripMenuItem_Click(object sender, EventArgs e)
        {
