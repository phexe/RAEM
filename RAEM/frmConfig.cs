    ...
    public partial class frmConfig : Form
    {
        ...
        private void fnReadINI()
        {
            ...
            foreach (string strLine in strLines)
            {
                ...
                if (strLine.ToLower().StartsWith("raem_retroarch_cores="))
                {
                    string strCores = strLine.ToLower().Replace("raem_retroarch_cores=", string.Empty);
        ...
        {
            StreamWriter srOut = new StreamWriter(Application.StartupPath + Path.DirectorySeparatorChar + "RAEM.ini",false);
            srOut.AutoFlush = true;

            srOut.WriteLine("raem_retroarch_exe=" + txtRetroArchExecutable.Text);
            srOut.WriteLine("raem_retroarch_cores=" + txtRetroArchCoresDir.Text.ToLower());
